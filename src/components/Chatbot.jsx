...
const Chatbot = () => {
    ...
    const processResponse = (input) => {
        ...
        if (lowerInput.includes('about') || lowerInput.includes('loop') || lowerInput.includes('club')) {
            return {
                text: "LOOP is the official technical club of GCET. We foster a community of developers, designers, and innovators through hackathons, workshops, and projects.",
                type: 'text'
            };
        }
